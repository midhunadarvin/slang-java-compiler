...
/**
 * This node represents Binary Divide (/) operator
 */
public class BinaryDivide extends Expression {
    /**
     * Divide has got a left expression (exp1 )
    ...
    public BinaryDivide(Expression e1, Expression e2) {
        exp1 = e1;
        exp2 = e2;
    }
