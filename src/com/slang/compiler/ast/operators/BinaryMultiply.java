...
/**
 * This node represents Binary Multiply (*) operator
 */
public class BinaryMultiply extends Expression {
    /**
     * Multiply has got a left expression (exp1 )
    ...
    public BinaryMultiply(Expression e1, Expression e2) {
        exp1 = e1;
        exp2 = e2;
    }
    ...
    public TypeInfo TypeCheck(COMPILATION_CONTEXT cont) throws Exception {
        ...
        if (eval_left == eval_right && eval_left == TypeInfo.TYPE_NUMERIC) {
            _type = eval_left;
            return _type;
        } else {
